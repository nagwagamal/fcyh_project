...
<?php /*%%SmartyHeaderCode:129555e208828771b39-99960943%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '129555e208828771b39-99960943',
  'function' => 
  array (
  ),
...
<body>
    <div class="app right-menu">
        <!-- top header -->
        <header class="header header-fixed navbar " style="background-color:#178a4e;">
