<?php /* Smarty version Smarty-3.0.8, created on 2020-01-26 17:33:43
         compiled from "./assets/themes\internal/categories.tpl" */ ?>
<?php /*%%SmartyHeaderCode:250615e2db1576a0092-88018034%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '250615e2db1576a0092-88018034',
  'function' =>
  array (
  ),
...
"><i class="fa fa-trash-o"></i></button>
          	                        ...
          	                        <?php }else{ ?><tr>
          	                            <td align="center" colspan="5"><b><?php echo $_smarty_tpl->getVariable('lang')->value['no_cities'];?>
</b></td>
          	                        </tr><?php }?>
          	                        <tfoot>
          	                            <tr>
...
" <?php if ($_smarty_tpl->getVariable('n')->value){?><?php if ($_smarty_tpl->getVariable('_c')->value['id']==$_smarty_tpl->getVariable('n')->value['cat_name']){?>selected="selected" <?php }?><?php }else{ ?> <?php if ($_smarty_tpl->getVariable('_c')->value['id']==$_smarty_tpl->getVariable('u')->value['parent_id']){?>selected="selected" <?php }?><?php }?>><?php echo $_smarty_tpl->getVariable('_c')->value['cat_name'];?>
 </option> <?php }} ?> </select> </div> <label class="col-sm-2 control-label"><?php echo $_smarty_tpl->getVariable('lang')->value['categories_1'];?>
</label>
          	                        </div>
          	                        <div class="form-group">
          	                            <div class="col-sm-10">
