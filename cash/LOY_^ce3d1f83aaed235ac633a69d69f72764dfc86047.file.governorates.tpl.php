...
" id="lang_name">
          		<input type="hidden" value="<?php echo $_smarty_tpl->getVariable('lang')->value['governorates'];?>
" id="sheet">
...
" id="lang_status">
 ...
 <b> <?php echo $_smarty_tpl->getVariable('lang')->value['governorates'];?>
 </b></h5>
								<br>
								...
								<div class="table-responsive">
									...
									<thead>
										<tr>
                                            ...
                                            <th><?php echo $_smarty_tpl->getVariable('lang')->value['country'];?>
</th>
...
">
												...
												<td>
													<a href="governorates.html?do=view&id=<?php echo $_smarty_tpl->getVariable('c')->value['id'];?>
"><?php echo $_smarty_tpl->getVariable('c')->value['gov_name_ar'];?>
 - <?php echo $_smarty_tpl->getVariable('c')->value['gov_name'];?>
</a> <br />
												</td>
                                                <td>
														<?php echo getFromTable(array('a'=>$_smarty_tpl->getVariable('c')->value['count_id'],'b'=>"country",'c'=>"getCountryInformation",'d'=>"count_name_ar"),$_smarty_tpl);?>
 - <?php echo getFromTable(array('a'=>$_smarty_tpl->getVariable('c')->value['count_id'],'b'=>"country",'c'=>"getCountryInformation",'d'=>"count_name"),$_smarty_tpl);?>

													</td>
												<td>
													<span <?php if ($_smarty_tpl->getVariable('group')->value['governorates_active']==1){?> id="active_<?php echo $_smarty_tpl->getVariable('c')->value['id'];?>
...
" enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="col-sm-10">
									<input type="text" class="form-control" name="gov_name_ar" placeholder="<?php echo $_smarty_tpl->getVariable('lang')->value['name_by_arabic'];?>
" value="<?php if ($_smarty_tpl->getVariable('n')->value){?><?php echo $_smarty_tpl->getVariable('n')->value['gov_name_ar'];?>
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('u')->value['gov_name_ar'];?>
<?php }?>">
								</div>
							...
							<div class="form-group">
								<div class="col-sm-10">
									<input type="text" class="form-control" name="gov_name" placeholder="<?php echo $_smarty_tpl->getVariable('lang')->value['name_by_english'];?>
" value="<?php if ($_smarty_tpl->getVariable('n')->value){?><?php echo $_smarty_tpl->getVariable('n')->value['gov_name'];?>
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('u')->value['gov_name'];?>
<?php }?>">
								</div>
...
"<?php if ($_smarty_tpl->getVariable('n')->value){?><?php if ($_smarty_tpl->getVariable('_c')->value['id']==$_smarty_tpl->getVariable('n')->value['country']){?>selected="selected"<?php }?><?php }else{ ?> <?php if ($_smarty_tpl->getVariable('_c')->value['id']==$_smarty_tpl->getVariable('u')->value['count_id']){?>selected="selected"<?php }?><?php }?>><?php echo $_smarty_tpl->getVariable('_c')->value['count_name_ar'];?>
 - <?php echo $_smarty_tpl->getVariable('_c')->value['count_name'];?>
								...
								<label class="col-sm-2 control-label"><?php echo $_smarty_tpl->getVariable('lang')->value['country'];?>
</label>
							</div>
...
?>
					...
					<?php }?>
					<section class="panel">
						<header class="panel-heading"> <?php echo $_smarty_tpl->getVariable('lang')->value['add_governorate'];?>
</header>
						<div class="panel-body">
...
<?php }?>">
                            ...
                            <div class="form-group">
								<div class="col-sm-10">
									<select class="form-control" name="country">
										<option value="0" selected="selected"><?php echo $_smarty_tpl->getVariable('lang')->value['choose_country'];?>
</option>
										<?php  $_smarty_tpl->tpl_vars["_c"] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('c')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
...
?>
											<option value="<?php echo $_smarty_tpl->getVariable('_c')->value['id'];?>
" <?php if ($_smarty_tpl->getVariable('_c')->value['id']==$_smarty_tpl->getVariable('n')->value['country']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->getVariable('_c')->value['count_name_ar'];?>
 - <?php echo $_smarty_tpl->getVariable('_c')->value['count_name'];?>
</option>
										<?php }} ?>
									</select>
							...
							<div class="form-group">
								<div class="col-sm-10"><button type="submit" class="btn btn-default"><?php echo $_smarty_tpl->getVariable('lang')->value['add_governorate'];?>
</button></div>
							</div>
						</form>
						</div>
