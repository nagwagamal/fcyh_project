...
include("./inc/Classes/system-complains.php");
	$complain = new systemComplains();
...
/*
					...
					$pager->doAnalysisPager("page",$page,$basicLimit,$complain->getTotalComplains(),"complains.html".$paginationAddons,$paginationDialm);
					$thispage = $pager->getPage();
					$limitmequry = " LIMIT ".($thispage-1) * $basicLimit .",". $basicLimit;
					$smarty->assign(area_name,"list");
					$smarty->assign('pager',$pager->getAnalysis());
					$smarty->assign(u,$complain->getsiteComplains($limitmequry));
			...
			break;
				...
				}else
				{
					...
					if($mId != 0)
					{
                        ...
                        $smarty->assign(u,$complain->getComplainsInformation($mId));
