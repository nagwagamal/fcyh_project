...
(function ($) {
  ...
  $.fn.tableExport = function (options) {
       ...
       var page=$('#sheet').val()+"("+ d.getDate() +"-"+ month +"-"+d.getFullYear()+")";
    ...
    var defaults = {
      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related options
        ...
        autotable: {
          styles: {
            ...
            halign:        'center',   // left, center, right or 'inherit' to use css horizontal cell alignment from html table
      ...
      tbodySelector:       'tr',
      tfootSelector:       ' ',        // Set empty ('') to prevent export of tfoot rows
      theadSelector:       'tr',
      tableName:           'Table',
    ...
    if (typeof defaults.excelRTL !== 'undefined' && defaults.rtl === 'undefined')
      defaults.rtl = defaults.excelRTL;
    ...
    if ( defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt' ) {
      ...
      for ( var j = 0; j < docDatas.length; j++ ) {
        xmlssDocFile += '<Worksheet ss:Name="' + docNames[j] + '" ss:RightToLeft="' + (defaults.rtl ? '1' : '0') + '">\r' +
          docDatas[j];
        if (defaults.rtl) {
