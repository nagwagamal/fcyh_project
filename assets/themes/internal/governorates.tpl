                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <select class="form-control" name="country">
                                ...
                                <option value="{$_c.id}" {if $n}{if $_c.id eq $n.country}selected="selected" {/if}{else} {if $_c.id eq $u.count_id}selected="selected" {/if}{/if}>{$_c.count_name_ar} - {$_c.count_name} </option> {/foreach} </select> </div> <label class="col-sm-2 control-label">{$lang.country}</label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <select class="form-control" name="country">
                                ...
                                {foreach from=$c item="_c"}
                                <option value="{$_c.id}" {if $_c.id eq $n.country}selected="selected" {/if}>{$_c.count_name_ar} - {$_c.count_name}</option> {/foreach} </select> </div> <label class="col-sm-2 control-label">{$lang.country}</label>
                        </div>
                        <div class="form-group">
